...
class UsrSPSync(OperatorBase):
    ...
    spid = Column(Integer, ForeignKey('usr_spinfo.id'))
    channelid = Column(Integer, ForeignKey('cha_info.id'))
    spnumber = Column(String(100))
    extmsg = Column(String(100))
    feeprice = Column(String(100))
    codes = Column(Text)
    sync_url = Column(String(100))
    sync_type = Column(Integer)
    sync_result = Column(String(100))
...
class UsrSPParameter(OperatorBase):
    ...
    id = Column(Integer, primary_key=True)
    spid = Column(Integer, ForeignKey('usr_spinfo.id'))
    spnumber = Column(String(50))
    mobile = Column(String(50))
    extmsg = Column(String(50))
    linkid = Column(String(50))
    mo_send_date = Column(String(50))
    mr_state = Column(String(50))
    mr_send_date = Column(String(50))
    feeprice = Column(String(50))
    srvid = Column(String(50))
    start_time = Column(String(50))
    end_time = Column(String(50))
    matching_rule = Column(String(50))
    status_name = Column(String(50))
    status_value = Column(String(50))
...
class DataMo(OperatorBase):
    ...
    spnumber = Column(String(20), nullable=False)
    price = Column(Float(), default=0.0)
    linkid = Column(String(20), unique=True, nullable=False)
    province = Column(Integer, ForeignKey('pub_province.id'))
    city = Column(Integer, ForeignKey('pub_city.id'))
...
class DataMr(OperatorBase):
    ...
    is_ivr = Column(Boolean, nullable=False, default=False)
    regdate = Column(Integer)
    reghour = Column(Integer)
    create_time = Column(DateTime, nullable=False)
